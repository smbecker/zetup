...
wget -c https://github.com/microsoft/azuredatastudio/releases/download/1.8.0/azuredatastudio-linux-1.8.0.deb
sudo dpkg -i azuredatastudio-linux-1.8.0.deb
rm azuredatastudio-linux-1.8.0.deb
