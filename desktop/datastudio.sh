...
wget -c https://github.com/microsoft/azuredatastudio/releases/download/1.15.1/azuredatastudio-linux-1.15.1.deb
sudo dpkg -i azuredatastudio-linux-1.15.1.deb
rm azuredatastudio-linux-1.15.1.deb
