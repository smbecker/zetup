...
wget -c https://download.jetbrains.com/rider/JetBrains.Rider-2019.3.4.tar.gz -O - | tar -xz -C $HOME/Tools/
mv $HOME/Tools/JetBrains\ Rider-2019.3.4/ $HOME/Tools/Rider/
...
mkdir -p $HOME/.Rider2019.3/config/plugins
