...
wget -c https://download.jetbrains.com/rider/JetBrains.Rider-2020.1.0.tar.gz -O - | tar -xz -C $HOME/Tools/
mv $HOME/Tools/JetBrains\ Rider-2020.1.0/ $HOME/Tools/Rider/
