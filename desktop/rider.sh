...
wget -c https://download.jetbrains.com/rider/JetBrains.Rider-2019.2.3.tar.gz -O - | tar -xz -C $HOME/Tools/
mv $HOME/Tools/JetBrains\ Rider-2019.2.3/ $HOME/Tools/Rider/
